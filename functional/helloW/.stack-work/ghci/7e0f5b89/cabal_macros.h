...
/* package helloW-0.1.0.0 */
#ifndef VERSION_helloW
#define VERSION_helloW "0.1.0.0"
#endif /* VERSION_helloW */
#ifndef MIN_VERSION_helloW
#define MIN_VERSION_helloW(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_helloW */
...
#define CURRENT_COMPONENT_ID "helloW-0.1.0.0-GaojCujbzpsKyQHiAj19Tb-helloW"
