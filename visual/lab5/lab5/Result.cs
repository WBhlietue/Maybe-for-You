...
namespace lab5
{
    ...
    {
        public FoodRegister reg;
        public Result(FoodRegister reg)
        {
            InitializeComponent();
            this.reg= reg;
            Set();
        ...
        void Set()
        {
            ...
            for (int i = 0; i < reg.ordered.Count; i++)
            {
                ...
                Label sizeLabel = GetLabel(reg.ordered[i].food.fSize.ToString());
        ...
        Label GetLabel(string text)
        {
            ...
            label.AutoSize = true;
            label.Font = new Font("Microsoft Sans Serif", 10F, FontStyle.Regular, GraphicsUnit.Point, 134);
